...
import 'package:uassnake/screens/login_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void submitScore() {
    ...
    database
        .collection('highscores')
        .add({"name": _currentUser.displayName, "score": currentScore});
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RawKeyboardListener(
        ...
        child: SizedBox(
          width: screenWidth > 415 ? 395 : screenWidth,
          child: Column(
            children: [
              //highscores
              Expanded(
